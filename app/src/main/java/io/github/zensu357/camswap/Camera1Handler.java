...
public class Camera1Handler implements ICameraHandler {
    ...
    private static boolean isOurCamera(Object cameraObj) {
        if (cameraObj == null) return false;
        return cameraObj.equals(HookMain.origin_preview_camera) ||
               cameraObj.equals(HookMain.start_preview_camera) ||
               cameraObj.equals(HookMain.mcamera1) ||
               cameraObj.equals(HookMain.camera_onPreviewFrame);
    }
